            ...
            <div className="col-lg-3">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input the student's identification number!"
                  }
                ]}
              >
                <Input
            ...
            <div className="col-lg-3">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please select the student's class!"
                  }
                ]}
              >
                <select
            ...
            <div className="col-lg-3">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input the student's gender!"
                  }
                ]}
              >
                <select
            ...
            <div className="col-lg-3">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input the father's/male guardian's email!"
                  }
                ]}
              >
                <Input
          ...
          <div className="row">
            <div className="col-lg-3">
              ...
              >
                <Input
                  prefix={
                    <WomanOutlined style={{ color: "rgba(0,0,0,.25)" }} />
                  }
                  type="text"
